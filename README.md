...
1. When you log into your AWS console, and in the search bar type secrets manager and on the page, select "Store a new secret" <br />
...
<img src="https://i.imgur.com/h0ses2s.png" height="80%" width="80%" alt="Store New Secret"/>
...
<img src="https://i.imgur.com/wbnTHDm.png" height="80%" width="80%" alt="Store New Secret"/>
5. This page is optional for rotating the secret, for the sake of testing, you can proceed and not modify anything
<img src="https://i.imgur.com/V4Hcb1Z.png" height="80%" width="80%" alt="Store New Secret"/>
...
<img src="https://i.imgur.com/xqlplbd.png" height="80%" width="80%" alt="Store New Secret"/>
7. After you select "store" you will get a green banner showing success
<img src="https://i.imgur.com/O4qXGpp.png" height="80%" width="80%" alt="Store New Secret"/>
